...
import r.android.app.AlertDialog;
import r.android.content.Context;
import r.android.content.DialogInterface;
import r.android.view.KeyEvent;
import r.android.widget.EditText;
...
public class CordovaDialogsHelper {
    ...
    public void showAlert(String message, final Result result) {
        ...
        dlg.setPositiveButton(r.android.R.string.ok,
    ...
    public void showConfirm(String message, final Result result) {
        ...
        dlg.setNegativeButton(r.android.R.string.cancel,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        result.gotResult(false, null);
                    }
